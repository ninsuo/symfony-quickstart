...
use Fuz\AppBundle\Entity\Test;
use Fuz\AppBundle\Form\TestType;
...
class TestController extends BaseController
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FuzAppBundle:Test')->findAll();
     ...
     * @Method("POST")
     * @Template("FuzAppBundle:Test:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FuzAppBundle:Test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FuzAppBundle:Test:edit.html.twig")
     */
